...
async def create_page(
    ...
    Args:
        ...
        menu_order: Order for menu placement.
        author: Author user ID.
        featured_media: Featured image media ID.
        password: Password protection.
    """
...
async def create_category(
    ...
    Args:
        ...
        parent: Parent category ID for hierarchical categories. 0 means top-level category.
    """
...
async def create_comment(
    ...
    Args:
        ...
        status: approve, hold, spam, or trash.
        parent: Parent comment ID for threaded replies. 0 means top-level comment.
...
async def create_navigation(
    ...
    Args:
        ...
        status: publish, future, draft, pending, private, or trash.
        slug: URL-friendly slug.
        content: Navigation content (menu items).
